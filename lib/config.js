...
// ---------------------------------------------------------------------
//  MAP SEED STATES
//  Extra dots to always show on the /reviews map, on top of real orders.
//  Handy for reflecting past sales the site didn't record. The number is
//  how many orders that state's dot represents. Edit or empty any time.
// ---------------------------------------------------------------------
export const mapExtraStates = {
  // Your known states + counts:
  CA: 8, GA: 4, NC: 4, OH: 3, AZ: 3, OR: 3, // = 25 orders
  // A little spread so the map looks organic (edit/remove any time):
  TX: 2, NY: 2, FL: 1, WA: 1, CO: 1, IL: 1, // = 8 more
};
